...
# as reported in the paper. Regenerated by logic_experiment.py at train time;
# transcribed here so the styled PDF can be rebuilt without retraining.
results = np.array([
    [0.59, 0.82, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00],  # depth=2
    [0.54, 0.74, 0.94, 0.99, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00],  # depth=4
    [0.56, 0.67, 0.91, 0.97, 0.98, 0.99, 0.99, 1.00, 0.99, 0.99],  # depth=6
    [0.58, 0.73, 0.90, 0.96, 0.98, 0.97, 0.97, 0.98, 0.97, 0.97],  # depth=8
    [0.58, 0.64, 0.82, 0.88, 0.92, 0.93, 0.94, 0.96, 0.95, 0.94],  # depth=10
    [0.58, 0.66, 0.85, 0.89, 0.92, 0.93, 0.93, 0.92, 0.93, 0.92],  # depth=12
    [0.54, 0.67, 0.82, 0.89, 0.91, 0.92, 0.90, 0.91, 0.90, 0.90],  # depth=14
])
